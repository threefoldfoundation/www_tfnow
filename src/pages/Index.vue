<template>
  <Layout>
    <div class="pt-8 md:pt-16">
      <div class="flex flex-col items-center">
        ...
        <h4 class="text-4xl text-center lg:text-5xl">
	Build + Deploy + Run = ONE Click        
        </h4>
        <p class="text-xl font-medium text-center">
          Autonomous and decentralized storage and compute owned by everyone, everywhere !
          <br>
          <strong class="text-ui-primary"><a href="https://www.youtube.com/watch?v=AAV4yYZ_P3k" target="_blank">Got a minute? See our story first</a></strong>
        </p>
  ...
  <h4 class="text-4xl text-center lg:text-5xl">
        <div class="embed-responsive embed-responsive-16by9">
             <!-- <iframe style="display: block; margin: auto;" width="700" height="420" src="https://www.youtube.com/embed/AAV4yYZ_P3k" allowfullscreen></iframe> -->
        ...
        <p class="mt-8 text-center">
          <span class="border-b border-dashed border-ui-primary text-ui-primary"></span>.
        </p>
